...
def read_dateConfig_file_set_parameter():
    ...
    if os.path.exists(os.path.join(os.path.dirname(__file__), "dateConfigWindows.ini")):
        try:
            conf = configparser.ConfigParser()
            conf.read(os.path.join(os.path.dirname(__file__), "dateConfigWindows.ini"), encoding="utf-8-sig")
